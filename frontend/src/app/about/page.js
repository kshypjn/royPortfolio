          ...
          {sections.length > 0 && (
            <>
              <div className="flex gap-6 mb-4 mt-2 text-xs sm:text-sm font-mono tracking-widest uppercase text-gray-600">
                <span className="border-b-2 border-black pb-1">Work</span>
                {/* Add more tabs if you add more categories in Strapi */}
              </div>
          ...
          {CTAtext && CTAlink && (
            <div className="mt-1 flex justify-center">
              <a
                ...
                className="inline-block px-5 py-2 bg-black text-white rounded-md font-semibold shadow border border-black text-sm tracking-wide transition-all duration-200 hover:bg-white hover:text-black hover:border-black focus:bg-white focus:text-black focus:border-black hover:shadow-2xl hover:-translate-y-1"
              >
                {CTAtext}
              </a>
            </div>
