      ...
      {articles.map((article) => (
        ...
        >
          ...
          <div className="flex flex-col flex-1 justify-between">
            <h3 className="text-lg font-serif font-semibold mb-1 group-hover:underline group-focus:underline transition-colors">
              {article.Title}
            </h3>
              ...
              {articles.map((article) => (
                ...
                >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-lg sm:text-xl font-serif font-semibold mb-2 underline-offset-4 group-hover:underline group-focus:underline transition-colors"
                  >
                    {article.Title}
                  </a>
